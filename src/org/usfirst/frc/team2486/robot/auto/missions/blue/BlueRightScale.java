package org.usfirst.frc.team2486.robot.auto.missions.blue;
...
public class BlueRightScale extends AutoMission
{
	public BlueRightScale()
	{
		super();
		...
		if(FieldData.charAt(1) == 'L')
		{
			...
			Commands.add(new Encoder(-440000, -400000, DistanceUnit.TICKS));
